...
1- Get Nuclei output text format and store it to a database
2- Filter your output by using (--filter-vuln, --filter-svr, --filter-proto) to show only what you are interested into.
3- The N2DB output is made to make the notification readable through "notify" tool. 
...
## Configuration
- Download the N2DB: `git clone https://github.com/warber0x/N2DB`.
